...
ブラウザで **http://localhost:3000/** を開きます（トップページ）。  
...
2. **開発サーバーを使う場合**  
   ...
   npm run dev
   ```
   起動時に「Port 3000 is in use」と出た場合は、表示されたポート（例: **3001**）で開く  
   → **http://localhost:3001/**
...
| 順番 | やること | 詳細 |
|------|----------|------|
| **1** | 開発サーバーで表示確認 | `npm run dev` で起動し、表示されたURL（例: http://localhost:3003/）でトップを開く |
